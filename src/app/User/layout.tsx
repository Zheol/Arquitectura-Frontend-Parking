        ...
        <div className="flex ">
            <div className=" h-[100vh] min-w-64 bg-[#17202A] block ">
                ...
                <div className=" block justify-center p-2 gap-y-4 text-xl text-white">
                    ...
                    <Link href={'/User'} className="flex items-center gap-x-4 hover:bg-slate-600 p-2 rounded-xl">
                        <AiFillFund size={32}/>
                        <h2>Home</h2>
                    </Link>

                    <Link href={'/User/Parking'} className="flex items-center gap-x-4 hover:bg-slate-600 p-2 rounded-xl">
                        <LuParkingCircle size={32}/>
                        <h2>Parking</h2>
                    </Link>

                    <Link href={'/User/Profile'} className="flex items-center gap-x-4 hover:bg-slate-600 p-2 rounded-xl">
